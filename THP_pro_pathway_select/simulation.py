...
# model import
import model
func = [model.model1, model.model2, model.model3, model.model4]
...
for number in range(4):
 ...
 if number == 0:
  seed(103)
  # file open
  with open('result_path1_solv10_wo_DHPAA_drain.csv','a',newline='') as f:
   writer = csv.writer(f)
  ...
  np.savetxt('eval_solv_10_path1_without_DHPAA_drain.csv', eval2, delimiter=',',header='Eval_index', fmt='%.5f')
  ...
  plt.savefig("output_histgram_eval_solv_10_path1_without_DHPAA_drain.png")
  #plt.show()
  plt.close()
  ...
  plt.savefig("output_boxplot_eval_solv_10_path1_without_DHPAA_drain.png")
  #plt.show()
  plt.close()
  ...
  # file open
  with open('result_path1_solv10_wi_DHPAA_drain.csv','a',newline='') as f:
   writer = csv.writer(f)
  ...
  # output of THP yield
  eval2 = np.c_[eval] / 50 * 100
  np.savetxt('eval_solv_10_path1_with_DHPAA_drain.csv', eval2, delimiter=',',header='Eval_index', fmt='%.5f')
  ...
  plt.savefig("output_histgram_eval_solv_10_path1_with_DHPAA_drain.png")
  plt.close()
  ...
  plt.savefig("output_boxplot_eval_solv_10_path1_with_DHPAA_drain.png")
  #plt.show()
  plt.close()
  ...
  # file open
  with open('result_path2_solv10_wo_DHPAA_drain.csv','a',newline='') as f:
   writer = csv.writer(f)
  ...
  # output of THP yield
  eval2 = np.c_[eval] / 50 * 100
  np.savetxt('eval_solv_10_path2_without_DHPAA_drain.csv', eval2, delimiter=',',header='Eval_index', fmt='%.5f')
  ...
  plt.savefig("output_histgram_eval_solv_10_path2_without_DHPAA_drain.png")
  plt.close()
  ...
  plt.savefig("output_boxplot_eval_solv_10_path2_without_DHPAA_drain.png")
  #plt.show()
  plt.close()
  ...
  with open('result_path2_solv10_wi_DHPAA_drain.csv','a',newline='') as f:
   writer = csv.writer(f)
  ...
  # output of THP yield
  eval2 = np.c_[eval] / 50 * 100
  np.savetxt('eval_solv_10_path2_with_DHPAA_drain.csv', eval2, delimiter=',',header='Eval_index', fmt='%.5f')
  
  df3 = eval2
  
  data = np.concatenate((df, df1, df2, df3), 1)
  ...
  plt.savefig("output_histgram_eval_solv_10_path2_with_DHPAA_drain.png")
  #plt.show()
  plt.close()
  ...
  plt.savefig("output_boxplot_eval_solv_10_path2_with_DHPAA_drain.png")
  #plt.show()
  plt.close()
...
np.savetxt('For_eval_models.csv', data, delimiter=',', header="Eval_index','Eval_index','Eval_index','Eval_index'", fmt='%.5f', comments = '')
...
plt.savefig("output_boxplot_aaaaa.png")
